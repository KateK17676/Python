...
from logic1 import is_valid_quaternary, add_quaternary, subtract_quaternary
...
class CalculatorGUI:
    ...
    def show_info(self):
        ...
        представленными в троичной симметричной системе.
        Автор: Костяева Екатерина ИУ7-21Б
        """
